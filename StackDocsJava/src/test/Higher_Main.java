...
public class Higher_Main {
	...
	public static void main(String[] args) {
		...
		// ###########################################################
		System.out.println(hs.getAllTopics().topics.size());
		Topic topic = new Topic();
		topic.topicId = 2;
		...
		System.out.println(hs.getAllLanguages().languageTag.size());
		Language language = new Language();// ("", 1);

		DeleteTableDTO del1 = hs.delete(language);
		System.out.println(del1.message);
		System.out.println(hs.getAllLanguages().languageTag.size());

		System.out.println(hs.getAllExamples().examples.size());
		Example example = new Example();
		example.exampleId = 1;
		DeleteTableDTO del2 = hs.delete(example);
		System.out.println(del2.message);
		System.out.println(hs.getAllExamples().examples.size());
	}
