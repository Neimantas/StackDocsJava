...
//		HigherServiceImpl hService = new HigherServiceImpl();
		if (languageId == 0) {
			System.out.println("########### languageId == 0 ");
			TopicsDTO allTitleDTO = hService.getAllTopics();
			String topicWord2 = topicWord.toLowerCase();
			if (allTitleDTO.isSuccess()) {
				System.out.println("########### languageId == 0 allTitleDTO.isSuccess()");
				if (topicWord2 != "") {
					System.out.println("########### languageId == 0 allTitleDTO.isSuccess() topicWord2 != \"\"");
					...
					System.out.println("########### languageId == 0  ELSE");
					return new TopicsFrontDTO(true, "success", topicsFront);
				}

			}
			return new TopicsFrontDTO(false, allTitleDTO.getMessage(), null);
		}
			...
			System.out.println("########### languageId tDTO.isSuccess()");
